...
const basePath = '/haha-1775710497351';
...
export default function Home() {
  ...
  const products = [{ n: 'Laughing Matter', d: 'Our flagship product, Laughing Matter, is a unique entertainment solution designed to bring people together and create unforgettable moments. With its interactive features and engaging content, it\'s perfect for social gatherings and events.', i: 'https://images.pexels.com/photos/13013778/pexels-photo-13013778.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Smile Maker', d: 'Smile Maker is a fun and interactive product that uses artificial intelligence to create personalized comedy sketches, ensuring that every user has a unique and laughter-filled experience.', i: 'https://images.pexels.com/photos/3735654/pexels-photo-3735654.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Joke Generator', d: 'Our Joke Generator product is a clever device that uses natural language processing to create hilarious and relevant jokes, making it a great addition to any party or social gathering.', i: 'https://images.pexels.com/photos/7947648/pexels-photo-7947648.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Comedy Kit', d: 'The Comedy Kit is a comprehensive package that includes a variety of hilarious games, puzzles, and activities, designed to bring people together and create a fun and entertaining experience.', i: 'https://images.pexels.com/photos/7451937/pexels-photo-7451937.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Giggle Box', d: 'Giggle Box is a subscription-based service that delivers a new and exciting comedy-themed product to your doorstep every month, ensuring that you always have something to look forward to and laugh about.', i: 'https://images.pexels.com/photos/19437857/pexels-photo-19437857.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">haha</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/8341821/pexels-photo-8341821.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              dad <span className="text-accent">Excellence.</span>
            </h1>
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              haha delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At haha, we are dedicated to providing innovative products that bring joy and excitement to our customers. With a focus on quality and customer satisfaction, we strive to be a leading brand in our industry. Our team is passionate about delivering exceptional products that exceed expectations.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be a renowned brand that spreads happiness and laughter through our unique products, making a positive impact on people\'s lives.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To design, develop, and deliver high-quality products that meet the evolving needs of our customers, while fostering a culture of innovation, creativity, and excellence.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">da</h4>
                  <p className="text-sm text-on-surface-variant">At haha, our first core value is to prioritize customer delight, ensuring that every interaction with our brand is memorable and satisfying.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">da</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value is to embrace a culture of continuous learning and improvement, driving innovation and growth through ongoing education and self-reflection.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/36753978/pexels-photo-36753978.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/3863830/pexels-photo-3863830.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">da</p>
                  </div>
                </div>
                <div className="flex gap-6">
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">haha</div>
            <p className="text-white/60 text-sm leading-relaxed">dad</p>
          </div>
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} haha. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
